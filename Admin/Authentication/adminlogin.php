...
<body>
    ...
    <div class="login-section">
        ...
        <div class="login-image-container">
            <img src="/watcher/assets/pic12.jpg" alt="image on log in" class="login-image">
            </div>
            <!-- login container -->
            <div class="login-container">
                <div class="login-info">
                    <h1>Login </h1>
                        <form action="../../include/adminlogininc.php" method="post" class="form-container">
                        ...
                        <a href="./adminsignin.php" class="link">Don't have an account?<span>Sign in </span></a>
                        </form>
                </div>
            </div>
    </div>
